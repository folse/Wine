#!/usr/bin/python 
# -*- coding: UTF-8 -*-
#2 5,14,22 * * * /usr/bin/python /home/ubuntu/wine/get_wine.py
import os
import time
import datetime
import xlsxwriter
...
if __name__ == '__main__':
	...
	for store in store_array:
		...
		if store != None:
			...
			cursor.execute("select * from inventory where store_id = %s and updated_at between %s and %s", (store_id, start_time, end_time))
